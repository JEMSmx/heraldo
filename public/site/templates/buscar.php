...
<div class="morphsearch-content">
    ...
    <h2>Imágenes</h2>
    <?php $pagesWithImages = $pages->find("template=album, images.count>0, (images.description~=$q), (images.tags%=$q), (images.autor|images.Dateoriginal%=$q)");
        $allImages = array();
...
<div class="dummy-column">
  <h2>Eventos</h2>
  <?php $albumes=$pages->find("template=album, (title%=$q), (images.description|images.tags~=$q), (category.title%=$q), (images.autor|images.Dateoriginal%=$q), limit=20, sort=-published");
...
<div class="dummy-column">
  <h2>Etiquetas</h2>
    <?php 
          ...
          $parray = $pages->find("template=album, images.tags%=$q");
          foreach($parray as $p) {
        ...
        <a class="dummy-media-object" href="<?php echo $config->urls->root; ?>tags/<?php echo $tag ?>">
